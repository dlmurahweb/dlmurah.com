...
const phoneValidation = [
  {
    regexp: {
      pattern: "^(?!\\+?620000000000$)[+0-9][0-9 ()-]{7,20}$",
      flags: "",
    },
    message:
      "Masukkan nomor WhatsApp resmi. Nomor seed 620000000000 tidak boleh digunakan.",
  },
];
...
export const CONTENT_MODEL_DEFINITIONS: ContentModelDefinition[] = [
  {
    ...
    definition: {
      ...
      fields: [
        ...
        symbol("footerNavigationHeading", "Judul navigasi footer"),
        symbol("footerAdminsHeading", "Judul admin footer"),
        symbol("footerChannelsHeading", "Judul saluran footer"),
        symbol("footerPrivacyLabel", "Label kebijakan privasi footer"),
        symbol("footerTermsLabel", "Label syarat layanan footer"),
        symbol("footerInactiveSuffix", "Suffix item footer tidak aktif"),
  ...
  },
  {
    ...
    definition: {
      ...
      fields: [
        ...
        symbol("navigationCtaLabel", "Label CTA navigasi"),
        symbol("navigationCtaCompactLabel", "Label CTA navigasi ringkas"),
        media("heroImage", "Gambar hero"),
        symbol("servicesEyebrow", "Eyebrow layanan"),
        symbol("servicesHeading", "Judul layanan", { required: true }),
        text("servicesDescription", "Deskripsi layanan", { required: true }),
        symbol("serviceCtaLabel", "Label tombol layanan"),
        symbol("adminsEyebrow", "Eyebrow admin"),
        symbol("adminsHeading", "Judul admin"),
        text("adminsDescription", "Deskripsi admin"),
        text("adminsWarning", "Catatan keamanan admin"),
        symbol("adminCtaLabel", "Label tombol admin"),
        symbol("inactiveContactLabel", "Label kontak tidak aktif"),
        symbol("activeContactFallbackLabel", "Label status kontak aktif"),
        symbol(
          "inactiveContactFallbackLabel",
          "Label status kontak tidak aktif",
        ),
        symbol("processEyebrow", "Eyebrow cara kerja"),
        text("processDescription", "Deskripsi cara kerja"),
        symbol("howItWorksHeading", "Judul cara kerja", { required: true }),
        symbol("featuresEyebrow", "Eyebrow keunggulan"),
        symbol("featuresHeading", "Judul keunggulan"),
        text("featuresDescription", "Deskripsi keunggulan"),
        symbol("featuresVisualCaption", "Caption visual keunggulan"),
        symbol("channelsEyebrow", "Eyebrow saluran"),
        symbol("channelsHeading", "Judul saluran"),
        text("channelsDescription", "Deskripsi saluran"),
        symbol("channelCtaLabel", "Label tombol saluran aktif"),
        text("inactiveChannelMessage", "Pesan saluran tidak aktif"),
        symbol("inactiveChannelCtaLabel", "Label tombol saluran tidak aktif"),
        symbol("aboutEyebrow", "Eyebrow tentang"),
        symbol("aboutHeading", "Judul tentang", { required: true }),
        richText("aboutContent", "Konten tentang", true),
        symbol("aboutValuesHeading", "Judul nilai layanan"),
        symbol("aboutValueOneLabel", "Nilai layanan 1"),
        symbol("aboutValueTwoLabel", "Nilai layanan 2"),
        symbol("aboutValueThreeLabel", "Nilai layanan 3"),
        symbol("finalCtaEyebrow", "Eyebrow CTA akhir"),
        symbol("finalCtaTitle", "Judul CTA akhir", { required: true }),
        text("finalCtaDescription", "Deskripsi CTA akhir", {
          required: true,
        }),
        symbol("finalCtaPrimaryLabel", "Label tombol admin CTA akhir"),
        symbol("finalCtaChannelLabel", "Label tombol saluran CTA akhir"),
        symbol(
          "finalCtaFallbackChannelLabel",
          "Label fallback saluran CTA akhir",
        ),
        symbol("faqEyebrow", "Eyebrow FAQ"),
        symbol("faqHeading", "Judul FAQ"),
        text("faqDescription", "Deskripsi FAQ"),
